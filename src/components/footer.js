  ...
  return (
    <footer className={`footer-footer ${props.rootClassName} `}>
      <div className="footer-container">
        <img
          alt="logo"
          src="/playground_assets/logo%20%5B1%5D-1500h.png"
          className="footer-image"
        />
        <span className="footer-text">
          ©2023 Vehicle Rental. All rights reserved.
        </span>
      ...
      <div className="footer-links-container">
        <div className="footer-container1">
          <div className="footer-container2">
            ...
            <span className="footer-text03">Yogyakarta</span>
            <span className="footer-text04">Jakarta</span>
            <span className="">Malang</span>
          </div>
        ...
        <div className="footer-container4">
          <div className="footer-container5">
            <span className="footer-text11">Support</span>
            <span className="footer-text12">Terms of service</span>
